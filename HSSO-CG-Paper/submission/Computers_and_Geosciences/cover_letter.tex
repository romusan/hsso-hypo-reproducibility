...
\signature{R\'omulo Sandoval Fl\'orez\\Corresponding author\\\texttt{romulo@ecci.edu.co}}
\address{Grupo de Investigaci\'on GIDMyM\\Universidad ECCI\\Carrera 19 No. 49--20\\Bogot\'a 111311, Colombia}
\date{\today}
...
The manuscript has not been published previously and is not under consideration elsewhere. Both authors approved the submitted version and declare no competing interests. The repository and data archive are identified in the Code and data availability section.
